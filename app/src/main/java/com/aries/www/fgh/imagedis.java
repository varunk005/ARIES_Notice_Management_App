...
public class imagedis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdata = new ArrayList<>();
        madapter = new vmadapter(imagedis.this, mdata);
      ...
      //  madapter.setOnItemClickListener(imagedis.this);
        ...
        mdb = myref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(imagedis.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(imagedis.this,posthome.class));
