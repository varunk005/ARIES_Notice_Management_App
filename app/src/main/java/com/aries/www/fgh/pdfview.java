...
public class pdfview extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mrecyclerview = findViewById(R.id.shrecycle);
 ...
 editText= findViewById(R.id.sertxt);
...
if(!s.toString().isEmpty()){
    ...
    search("");
        ...
        mdata = new ArrayList<>();
        pdr = new pdapter(pdfview.this,mdata);
...
mrecyclerview.addOnScrollListener(new RecyclerView.OnScrollListener() {
    ...
    public void logout()
    {
        ...
        mauth.signOut();
        pdfview.this.finish();
        startActivity(new Intent(pdfview.this,hma.class));
    }
}